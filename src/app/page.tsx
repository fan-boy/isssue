  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-14 h-5 bg-[#f0e6a0]/70 transform -rotate-1 z-10" />
      ...
      <div className="p-5">
        ...
        <p className="text-sm text-[#666] mb-4 leading-relaxed italic">"{caption}"</p>
